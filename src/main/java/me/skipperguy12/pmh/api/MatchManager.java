...
import me.skipperguy12.pmh.api.backend.BackendManager;
...
public final class MatchManager {
	 ...
	 * 
	 * A single match environment is one where only one match will be running on the server. In that case, this method should always return a valid match object, though it is not guaranteed.
	 * 
	 * @return only match running or null if there are either no matches running or more than one
	 */
