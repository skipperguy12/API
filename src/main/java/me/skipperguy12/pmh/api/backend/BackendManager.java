...
/**
 * Responsible for storing the current instance that backs Project Ares static API calls.
 * 
 * This class is primarily intended for internal usage and should not be called by users of the API.
 * 
 * @see Backend
 */
public final class BackendManager {
	...
	/**
	 * Gets the backend that is currently registered. This method should not be called by users of the API, but rather should be accessed indirectly by calling static API entry points.
	 * 
	 * @return {@link Backend} instance of the API implementation
	 * @throws IllegalStateException
	 *             if there is not a backend registered
	 */
	 ...
	 * 
	 * @param newBackend
	 *            New {@link Backend} instance or null to clear the stored backend
	 * @return Backend that was registered before replaced by this backend
	 */
	public static synchronized @Nullable
	Backend setBackend(@Nullable Backend newBackend) {
