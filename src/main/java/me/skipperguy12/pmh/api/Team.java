...
public interface Team {
	 ...
	 * 
	 * Equivalent to looping through all members of the team and sending the message using Bukkit's {@link org.bukkit.entity.Player#sendMessage}.
	 * 
	 * @param message
	 ...
	 * 
	 * This method will return either the initial color for the team or any custom color set via {@link #setColor}. Getting the initial color is supported by {@link #getInitialColor}.
	 * 
	 ...
	 * 
	 * This method will use any custom-set name or color in its output. Get the initial name and color by calling {@link #getInitialName} and {@link #getInitialColor}.
	 * 
	 ...
	 * 
	 * This method will return either the initial name or any modifications applied with {@link #setName}. Getting the initial name is supported by {@link #getInitialName}.
	 * 
	 ...
	 * 
	 * Equivalent to checking that the team can participate and that the match is currently running.
	 * 
	 ...
	 * 
	 * This will return true even if the team may be able to participate but is currently spectating because the match has not yet started.
	 * 
	 ...
	 * 
	 * @param newName
	 *            new name for the team (exclude colors)
	 * @throws NullPointerException
